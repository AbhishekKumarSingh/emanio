...
addLoadListener(initTodoWidget);

function initTodoWidget()
{
  if (typeof(document.designMode) == "string" && (document.all || document.designMode == "off"))
  {
    var textareas = getElementsByAttribute("class", "TodoWidget");

    for (var i = 0; i < textareas.length; i++)
    {
      convertTodoWidget(textareas[i]);
    }
  }
...
function convertTodoWidget(textarea)
{
  ...
  iframe.className = "TodoWidgetIframe";
  ...
  buttonBold.onclick = executeTodoWidget;
  toolbar.appendChild(buttonBold);

  var buttonItalic = document.createElement("a");
  buttonItalic.className = "TodoWidgetButtonItalic";
  ...
  buttonItalic.onclick = executeTodoWidget;
  toolbar.appendChild(buttonItalic);

  var buttonSmile = document.createElement("a");
  buttonSmile.className = "TodoWidgetButtonSmile";
...
function executeTodoWidget(event)
{
